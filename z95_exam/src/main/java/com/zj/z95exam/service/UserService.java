...
public interface UserService extends IService<User> {
     ...
     * @return 新用户 id
     */
    long userRegister(String userAccount, String userPassword, String checkPassword, Long classId, Integer number, String userName);
     ...
     * 分页获取用户列表
     *
     * @param userQueryRequest dto 用户查询请求
     * @param teacher          登录用户
     * @return 用户列表
     */
    Page<User> listUser(UserQueryRequest userQueryRequest, User teacher);
}
